...
namespace DoanQLKS
{
    internal class Thanhtoan1
    {
        ...
        public Thanhtoan1(string id_hoadon, string id_nhanvien, string id_uudai, string id_datphong, int tienphong, int tiendv, int tongtien)
        {
